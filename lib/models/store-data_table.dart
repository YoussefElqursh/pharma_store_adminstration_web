...
class StoreData {
  ...
  StoreData(this.id, this.photo, this.name, this.contactNumber, this.address, this.moreIcon);
  final int id;
  final String photo;
  final String name;
